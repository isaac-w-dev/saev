...
@app.cell
def _(compile_info, genus_paths, get_i, mo, os):
    def display_by_genus(genus_directory, get_i):
        ...
        for species in os.listdir(directory):
            ...
            # for species_instance in os.listdir(species_path):
            #     species_instance_path = species_path + '/' + species_instance
            #     print(species_instance_path)
                # genus_grid.append(compile_info(species_instance_path))
